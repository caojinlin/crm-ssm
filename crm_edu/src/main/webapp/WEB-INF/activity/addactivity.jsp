            ...
            <tr>
                ...
                <td valign="top" background="<%=path %>/Images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="./<%=path %>/Images/content_bg.gif">
                        <tr><td height="31"><div class="title">添加交往</div></td></tr>
                    </table>
                </td>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">添加交往的基本信息！</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                        ...
                                        <td colspan="2">
                                            <form action="addactivity.do" method="post">
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;<input type="hidden" name="cid" value="${cid }"/> </td>
                                                        <td width="10%">时间：</td>
                                                        <td width="20%"><input type="text" name="meettime" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"/></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                   <tr>
                                                        <td width="2%">&nbsp;<input type="hidden" name="cname" value="${cname }"/> </td>
                                                        <td width="10%">地点：</td>
                                                        <td width="20%"><input class="text" type="text" name="place" value="" /></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>详情：</td>
                                                        <td><input class="text" type="text" name="des" value="" /></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>备注：</td>
                                                        <td><input class="text" type="text" name="remark" value="" /></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
